...
class PeriodicElement(Base):
    __tablename__ = 'PeriodicElement'
    symbol = Column(String(10),primary_key = True,nullable=False)
    fullName = Column(String(250),nullable=False)
    atomicNumber = Column(Integer,nullable=False)
    def __init__(self, symbol,fullName,atomicNumber):
        self.symbol = symbol
...
class ParameterTable(Base):
    ...
    def __init__(self, nameParameter, numberOfAtoms ,classOrType):
...
class ScalingFactorTable(Base):
    ...
    idForceField = Column(Integer, ForeignKey('ForceField.idForceField'),primary_key=True,nullable=False)
    nameScalingFactor = Column(String(250),primary_key=True,nullable=False)
    ...
    def __init__(self, idForceField,nameScalingFactor,key,value ,idParameter ):
        self.key = key
        self.idForceField = idForceField
        self.idParameter = idParameter
        self.value = value
        self.nameScalingFactor = nameScalingFactor
