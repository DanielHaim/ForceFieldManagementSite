...
class User(Base):
    ...
    #a gerer avec le login et logout
    last_login_at = Column(DateTime,nullable=True)
    #a gerer avec login et logout
    ...
    def generateUserToken(self):
        ...
        return serializer.dumps(self.username)
...
class ForceField(Base):
    ...
    #mettre UNIQUE A TRUE pour le nameFF
...
class ForceFieldSchema(ma.ModelSchema):
    class Meta:
        model = ForceField
        fields = ('idForceField','nameForceField')
